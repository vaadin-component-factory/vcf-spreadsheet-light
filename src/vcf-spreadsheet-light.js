...
/**
 * `<vcf-spreadsheet-light>` Web Component providing basic functionalities of a spreadsheet.
 *
 * ```html
 * <vcf-spreadsheet-light></vcf-spreadsheet-light>
 * ```
 *
 * @memberof Vaadin
 * @mixes ElementMixin
 ...
 */
class VcfSpreadsheetLight extends ElementMixin(ThemableMixin(PolymerElement)) {
  static get template() {
    return html`
